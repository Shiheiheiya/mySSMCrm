...
<%--<%@ taglib prefix="wc" uri="http://weichuang/utils/"%>--%>
<%--<%--%>
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/getCustomerListByCondition.do" method="post">
						...
						<div class="form-group">
							...
							<select	class="form-control" id="customerFrom" placeholder="客户来源" name="custSource">
								...
								<c:forEach items="${custSourceTypes}" var="item">
									<option value="${item.dictId}"<c:if test="${item.dictId == condition.custSource}"> selected</c:if>>${item.dictItemName}</option>
								</c:forEach>
							</select>
						</div>
						<div class="form-group">
							...
							<select	class="form-control" id="custIndustry"  name="custIndustry">
								<option value="">--请选择--</option>
								<c:forEach items="${custIndustryTypes}" var="item">
									<option value="${item.dictId}"<c:if test="${item.dictId == condition.custIndustry}"> selected</c:if>>${item.dictItemName}</option>
								</c:forEach>
							</select>
						</div>
						<div class="form-group">
							...
							<select	class="form-control" id="custLevel" name="custLevel">
								<option value="">--请选择--</option>
								<c:forEach items="${custLevelTypes}" var="item">
									<option value="${item.dictId}"<c:if test="${item.dictId == condition.custLevel}"> selected</c:if>>${item.dictItemName }</option>
								</c:forEach>
							</select>
						</div>
							...
							<tbody>
								<c:forEach items="${customerList}" var="customer">
									<tr>
										...
										<td>
											<a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerEditDialog" onclick="editCustomer(${customer.custId})">修改</a>
											<a href="#" class="btn btn-danger btn-xs" onclick="deleteCustomer(${customer.custId})">删除</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" id="edit_customer_form" action="/cutomerList.do" method="get">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select	class="form-control" id="edit_customerFrom" placeholder="客户来源" name="custource">S
									<option value="">--请选择--</option>
